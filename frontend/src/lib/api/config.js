...
export const API_ENDPOINTS = {
  ...
  GROCERY_STORE: {
    AUTH: {
      SEND_OTP: '/grocery/store/auth/send-otp',
      VERIFY_OTP: '/grocery/store/auth/verify-otp',
      REGISTER: '/grocery/store/auth/register',
      LOGIN: '/grocery/store/auth/login',
      FIREBASE_GOOGLE_LOGIN: '/grocery/store/auth/firebase/google-login',
    ...
    ONBOARDING: '/grocery/store/onboarding',
    PROFILE: '/grocery/store/profile',
    DELIVERY_STATUS: '/grocery/store/delivery-status',
    OUTLET_TIMINGS: '/grocery/store/outlet-timings',
    OUTLET_TIMINGS_DAY: '/grocery/store/outlet-timings/day/:day',
    BY_OWNER: '/grocery/store/owner/me',
    ORDERS: '/grocery/store/orders',
    ORDER_BY_ID: '/grocery/store/orders/:id',
    ORDER_ACCEPT: '/grocery/store/orders/:id/accept',
    ORDER_REJECT: '/grocery/store/orders/:id/reject',
    ORDER_PREPARING: '/grocery/store/orders/:id/preparing',
    ORDER_READY: '/grocery/store/orders/:id/ready',
    ORDER_RESEND_DELIVERY_NOTIFICATION: '/grocery/store/orders/:id/resend-delivery-notification',
    NOTIFICATIONS: '/grocery/store/notifications',
    NOTIFICATION_BY_ID: '/grocery/store/notifications/:id',
    WALLET: '/grocery/store/wallet',
    WALLET_TRANSACTIONS: '/grocery/store/wallet/transactions',
    ...
    PRODUCT_CREATE: '/grocery/store/products',
    PRODUCT_UPDATE: '/grocery/store/products/:id',
    PRODUCT_DELETE: '/grocery/store/products/:id',
    ADDONS: '/grocery/store/menu/addons',
    ADDON: '/grocery/store/menu/addon',
    ADDON_BY_ID: '/grocery/store/menu/addon/:id',
    CATEGORY_REQUEST_CREATE: '/grocery/store/category-requests',
    CATEGORY_REQUESTS: '/grocery/store/category-requests',
    SUBCATEGORY_REQUEST_CREATE: '/grocery/store/subcategory-requests',
    SUBCATEGORY_REQUESTS: '/grocery/store/subcategory-requests',
    // Public read-only (no auth required)
    CATEGORIES: '/grocery/categories',
    SUBCATEGORIES: '/grocery/subcategories',
  },
  // Delivery endpoints
  DELIVERY: {
    AUTH: {
  ...
  ADMIN: {
    ...
    GROCERY_STORE_REQUESTS: '/admin/grocery-stores/requests',
    GROCERY_STORE_APPROVE: '/admin/grocery-stores/:id/approve',
    GROCERY_STORE_REJECT: '/admin/grocery-stores/:id/reject',
    GROCERY_STORE_BY_ID: '/admin/grocery-stores/:id',
    ...
    GROCERY_WITHDRAWAL_REQUESTS: '/admin/grocery-withdrawal/requests',
    GROCERY_WITHDRAWAL_APPROVE: '/admin/grocery-withdrawal/:id/approve',
    GROCERY_WITHDRAWAL_REJECT: '/admin/grocery-withdrawal/:id/reject',
    ...
    GROCERY_APPROVALS: '/admin/grocery-approvals',
    GROCERY_APPROVAL_APPROVE: '/admin/grocery-approvals/:id/approve',
    GROCERY_APPROVAL_REJECT: '/admin/grocery-approvals/:id/reject',
    OFFERS: '/admin/offers',
    ZONES: '/admin/zones',
