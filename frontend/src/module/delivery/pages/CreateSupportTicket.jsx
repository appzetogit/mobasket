        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div>
            ...
            <Textarea
              ...
              rows={8}
              maxLength={2000}
              className={`w-full px-3 py-2.5 border rounded-lg bg-white resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.description ? "border-red-500" : "border-gray-300"}`}
            />
            {errors.description && (
