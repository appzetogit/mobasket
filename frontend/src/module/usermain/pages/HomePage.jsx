...
export default function HomePage() {
  ...
  const toggleWishlist = (item, type = "food") => {
    const itemId =
      type === "food" ? `food-${item.id}` : `restaurant-${item.id}`;
    ...
    setWishlist((prev) => {
      ...
      if (isInWishlist) {
        ...
        toast.success(
          `Your ${type === "food" ? "food item" : "restaurant"} "${itemName}" is added to wishlist`,
        );
  ...
  return (
    <div className="min-h-screen bg-[#f6e9dc] overflow-x-hidden pb-20">
      ...
      <div className="px-4 mb-6">
        <h3 className="text-lg font-bold text-[#ff8100] mb-1">
          Today's Trends
        </h3>
            ...
            >
              ...
              <div className="p-2.5 flex flex-col flex-1">
                ...
                <div className="flex items-center justify-between gap-2 mb-2">
                  <h4 className="text-xs font-bold text-gray-900 flex-1 line-clamp-2">
                    {item.name}
                  </h4>
        ...
        >
          <div className="flex items-center gap-3 md:gap-6 p-4 md:p-8 h-full">
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center">
              <h3 className="text-base md:text-2xl font-bold text-gray-900 mb-0.5 md:mb-2 whitespace-nowrap">
                Find Nearby
              </h3>
              <p className="text-[10px] md:text-sm text-gray-700 leading-tight">
            ...
            <div className="flex flex-col items-center gap-2 md:gap-3 flex-shrink-0">
              ...
              <div className="relative">
                <MapPin
                  className="w-6 h-6 md:w-10 md:h-10 text-red-500"
                  fill="red"
                />
              </div>
              {/* See Location Button */}
