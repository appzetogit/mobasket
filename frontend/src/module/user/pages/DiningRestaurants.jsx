...
export default function DiningRestaurants() {
  ...
  return (
    <AnimatedPage
      className="bg-white"
      style={{ minHeight: "100vh", paddingBottom: "80px", overflow: "visible" }}
    >
                ...
                return (
                  ...
                  >
                    <Card className="overflow-hidden gap-0 cursor-pointer border border-gray-100 dark:border-gray-800 group bg-white dark:bg-[#1a1a1a] transition-all duration-300 py-0 rounded-[24px] flex flex-col h-full w-full relative shadow-sm hover:shadow-md">
                      {/* Image Section */}
                      <div className="relative aspect-[16/9] w-full overflow-hidden rounded-t-[24px]">
                        <img
                        ...
                        >
                          <Bookmark
                            className={`h-4 w-4 ${favorite ? "fill-rose-500 text-rose-500" : "text-gray-600 dark:text-gray-400"}`}
                          />
                        </Button>

                        {/* Blue Section - Bottom Overlay */}
                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-blue-600/90 via-blue-600/40 to-transparent pt-8 pb-4 px-4">
                          <p className="text-white text-[10px] font-bold uppercase tracking-wider mb-0.5 opacity-90">
                            PRE-BOOK TABLE
                          </p>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-sm font-medium ${activeFilters.has("delivery-under-30") ? "text-green-600" : "text-gray-700"}`}
                        >
                          Under 30 mins
                        </span>
                      </button>
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-sm font-medium ${activeFilters.has("delivery-under-45") ? "text-green-600" : "text-gray-700"}`}
                        >
                          Under 45 mins
                        </span>
                      </button>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-sm font-medium ${activeFilters.has("rating-35-plus") ? "text-green-600" : "text-gray-700"}`}
                        >
                          Rated 3.5+
                        </span>
                      </button>
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-sm font-medium ${activeFilters.has("rating-4-plus") ? "text-green-600" : "text-gray-700"}`}
                        >
                          Rated 4.0+
                        </span>
                      </button>
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-sm font-medium ${activeFilters.has("rating-45-plus") ? "text-green-600" : "text-gray-700"}`}
                        >
                          Rated 4.5+
                        </span>
                      </button>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-sm font-medium ${activeFilters.has("distance-under-1km") ? "text-green-600" : "text-gray-700"}`}
                        >
                          Under 1 km
                        </span>
                      </button>
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-sm font-medium ${activeFilters.has("distance-under-2km") ? "text-green-600" : "text-gray-700"}`}
                        >
                          Under 2 km
                        </span>
                      </button>
