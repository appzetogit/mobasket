...
export default function RestaurantDetails() {
      ...
      try {
        ...
        if (apiRestaurant) {
          ...
          const formatRestaurantAddress = (locationObj) => {
            ...
            if (
              ...
              locationObj.formattedAddress.trim() !== "" &&

              locationObj.formattedAddress !== "Select location"
              ...
              if (!isCoordinates) {
                ...
                if (hasPinCode) {
                  ...
                  const cleanedAddr = formattedAddr.replace(
            ...
            if (
              ...
              if (!isCoordinates) {
                ...
                const cleanedAddr = locationObj.formattedAddress
          ...
          const restaurantLat =
            ...
            (locationObj?.coordinates && Array.isArray(locationObj.coordinates)

              ? locationObj.coordinates[1]
          ...
          const transformedRestaurant = {
            ...
            deliveryTime:
              ...
              actualRestaurant?.estimatedDeliveryTime ||

              apiRestaurant?.estimatedDeliveryTime ||

              actualRestaurant?.deliveryTime ||

              apiRestaurant?.deliveryTime ||

              actualRestaurant?.avgDeliveryTime ||

              apiRestaurant?.avgDeliveryTime ||
            ...
            restaurantOffers: {
              ...
              goldOffer: {
                ...
                title:
                  ...
                  apiRestaurant?.restaurantOffers?.goldOffer?.title ||

                  "Gold exclusive offer",

                description:

                  apiRestaurant?.restaurantOffers?.goldOffer?.description ||

                  "Free delivery above ₹99",

                unlockText:

                  apiRestaurant?.restaurantOffers?.goldOffer?.unlockText ||

                  "join Gold to unlock",

                buttonText:

                  apiRestaurant?.restaurantOffers?.goldOffer?.buttonText ||
            ...
            outlets: Array.isArray(apiRestaurant?.outlets)

              ? apiRestaurant.outlets

              : [],

            categories: Array.isArray(apiRestaurant?.categories)

              ? apiRestaurant.categories
            ...
            slug:
              ...
              apiRestaurant?.name?.toLowerCase().replace(/\s+/g, "-") ||
            ...
            openDays: Array.isArray(apiRestaurant?.openDays)
            ...
            cuisines: Array.isArray(apiRestaurant?.cuisines)
            ...
            menuImages: Array.isArray(apiRestaurant?.menuImages)
        ...
        if (isNetworkError) {
          ...
          console.error(
            ...
            "Network error fetching restaurant (backend may not be running):",
          ...
          setRestaurantError(
            ...
            "Backend server is not connected. Please make sure the backend is running.",
  ...
  const updateItemQuantity = (item, newQuantity, event = null) => {
    ...
    if (!restaurant || !restaurant.name) {
      ...
      toast.error(
        ...
        "Restaurant information is missing. Please refresh the page.",
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setCurrentImageIndex((prev) => {
        ...
        const offersLength = Array.isArray(restaurant?.offers)
  ...
  if (restaurantError && !restaurant) {
    ...
    const isNetworkError = restaurantError.includes(
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <AlertCircle
              ...
              className={`h-12 w-12 ${isNetworkError ? "text-orange-500" : "text-red-500"}`}
        ...
        <div className="bg-white dark:bg-[#1a1a1a] rounded-[24px] shadow-xl p-5 border border-gray-100 dark:border-gray-800">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[13px] text-gray-500 font-medium mt-1 line-clamp-1">

                {restaurant?.cuisine || "North Indian, Fast Food, Chinese"}
            ...
            <div className="flex flex-col items-end gap-1">
              ...
              <div className="bg-[#15803d] text-white px-2 py-0.5 rounded-lg flex items-center gap-1 text-[14px] font-black shadow-sm">

                <span>{restaurant?.rating}</span>

                <Star className="h-3 w-3 fill-white" strokeWidth={3} />

              </div>

              <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider text-right">
          ...
          <div className="flex items-center gap-4 text-sm font-bold border-t border-dashed pt-4 dark:border-gray-800">
                              ...
                              <div className="flex items-center gap-3 text-xs text-gray-600 dark:text-gray-400">
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <span>
                                    ...
                                    {outlet?.deliveryTime || "25-30 mins"}
                              ...
                              <div className="flex flex-col items-end gap-0.5">
                                ...
                                <span className="text-xs text-gray-500 dark:text-gray-400">
                                  ...
                                  {(outlet?.reviews || 0) >= 1000
                                    ...
                                    ? `${((outlet.reviews || 0) / 1000).toFixed(1)}K+`
                      ...
                      <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-3 bg-white dark:bg-[#1a1a1a]">
                        ...
                        <button className="flex items-center justify-center gap-2 text-red-600 dark:text-red-400 font-medium text-sm w-full">
                          ...
                          <span>
                            ...
                            See all {restaurant.outlets.length} outlets
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                          ...
                          {getDishFavorites().length} dishes •{" "}
                    ...
                    <div className="flex items-center gap-3 mb-4 overflow-x-auto pb-2 scrollbar-hide">
                      ...
                      {(() => {
                        ...
                        return dates.map((item, index) => {
                          ...
                          const day = String(item.date.getDate()).padStart(
                ...
                >
                  ...
                  <div className="flex-1 overflow-y-auto px-4 py-4">
                    ...
                    {restaurant?.restaurantOffers?.coupons &&
                      ...
                      Array.isArray(restaurant.restaurantOffers.coupons) &&

                      restaurant.restaurantOffers.coupons.length > 0 && (
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            ...
                            {restaurant.restaurantOffers.coupons.map(

                              (coupon) => {

                                const isExpanded = expandedCoupons.has(
                  ...
                  <div className="flex-1 overflow-y-auto px-4 py-4">
                    ...
                    <div className="mt-6 px-2">
                      ...
                      <p className="text-xs text-gray-500 leading-relaxed">
                        ...
                        Menu items, prices, photos and descriptions are set

                        directly by the restaurant. In case you see any

                        incorrect information, please report it to us.
